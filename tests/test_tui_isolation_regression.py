"""Legacy TUI isolation regression (P2): default launch stays legacy-only.

Covers handoff P2 checks: separate legacy vs opt-in shell startup, palette
contents, cancel, narrow-terminal history, theme switch, clean exit.
"""
...
def test_shell_opt_out_by_default_without_env(monkeypatch) -> None:
