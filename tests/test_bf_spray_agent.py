"""Tests for bf_spray_agent — PROBE, EXPLOIT, CHAIN CHECK stages."""
...
@pytest.fixture
def base_state():
    """Supports regression tests for test bf spray agent."""
