"""Access Control Force Browse agent."""
...
_CHAIN_OUTCOME = "admin_session_obtained"

_DEFAULT_PROBE = ["/config/", "/backup/"]
_DEFAULT_EXPLOIT = ["/admin/"]
_DEFAULT_BYPASS = {
    "medium": ["/admin%2f"],
    "high": ["/admin/./"],
}
...
def ac_force_browse_agent(state: ExploitationState) -> dict[str, Any]:
    """Run PROBE -> EXPLOIT -> CHAIN CHECK for ac_force_browse."""
